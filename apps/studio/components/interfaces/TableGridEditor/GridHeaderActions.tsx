...
const GridHeaderActions = ({ table }: GridHeaderActionsProps) => {
  ...
  const { data: lints = [] } = useProjectLintsQuery({ branch })
  ...
  const { can: canSqlWriteTables, isLoading: isLoadingPermissions } = useCheckPermissions("branch:auth:admin")
  const { can: canSqlWriteColumns } = useCheckPermissions("branch:auth:admin")
        ...
        <div className="space-y-2">
          ...
          {!isRealtimeEnabled && (
            <p className="text-sm">
              ...
              <Link
                href={`/org/${orgRef}/project/${projectRef}/branch/${branchRef}/database/publications`}
