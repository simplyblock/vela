...
2. This spec introduces CRD-driven reconciliation for install/upgrade/operations.
...
4. Secret data MUST NOT be stored in CRD spec/status plaintext.
...
4. Commit 4: upgrade/backup/conformance reconcilers.
5. Commit 5: metrics, events, and air-gapped packaging.
...
2. Condition and event streams are actionable.
3. Air-gapped operator deployment path is documented and tested.
